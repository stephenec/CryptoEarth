...
class Ocean_Extra_Theme_Panel {
	...
	*/
	...
	public static function admin_page_sidebar() {
		...
		<div class="oceanwp-button">
			<a href="https://www.youtube.com/c/OceanWP" class="button owp-button owp-yt-btn" target="_blank"><i class="dashicons dashicons-video-alt3"></i><?php esc_html_e( 'Check video tutorials', 'ocean-extra' ); ?></a>
		</div>
